...
public class FlowerManager : MonoBehaviour {
    ...
    {  
        ...
        {
            GameObject temp = (GameObject)Instantiate(m_FlowerPrefab[Random.Range(0, m_FlowerPrefab.Length)], new Vector3(0, m_RightTop.y + 2, 0), Quaternion.identity);
            //총알을 생성하고
